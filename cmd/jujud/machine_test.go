...
import (
	...
	lxctesting "github.com/juju/core/container/lxc/testing"
	...
	charmtesting "github.com/juju/core/state/apiserver/charmrevisionupdater/testing"
...
func (s *MachineSuite) TestDyingMachine(c *gc.C) {
	...
	case <-time.After(watcher.Period * 5 / 4):
		...
		// https://bugs.github.com/juju/core/+bug/1163983
