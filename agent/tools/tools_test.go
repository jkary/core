...
import (
	...
	coretest "github.com/juju/core/tools"
...
func (t *ToolsSuite) TestPackageDependencies(c *gc.C) {
	...
	// Only imports that start with "github.com/juju/core" are checked, and the
	// resulting slice has that prefix removed to keep the output short.
	c.Assert(testing.FindJujuCoreImports(c, "github.com/juju/core/agent/tools"),
		gc.DeepEquals,
